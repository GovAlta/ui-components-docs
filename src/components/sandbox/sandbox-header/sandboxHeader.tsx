      ...
      <div className="header-container">
        ...
        <div className="heading-group">
          ...
          <GoabTooltip content={isCopied ? "Copied" : "Copy link"}>
            ...
            >
              <goa-icon
                type="copy"
                theme={isHovering ? "filled" : "outline"}
                style={{ width: "var(--goa-icon-size-1)", height: "var(--goa-icon-size-1)", marginBottom: "10px" }}
              />
            </button>
          </GoabTooltip>
        </div>
        ...
        {props.figmaExample && (
          <GoabTooltip content="View in Figma">
            <a href={props.figmaExample} className="icon-link no-external-icon" target="_blank"
              ...
              <svg className="icon-default" width="18" height="18" viewBox="0 0 24 24" fill="none"
                ...
                <path
                  ...
                  stroke="var(--goa-color-text-secondary)" stroke-width="1.28947" />
                <path
