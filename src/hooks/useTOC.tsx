...
export const useTOC = () => {
  ...
  const updateTOC = debounce((defaultHeadings?: NodeListOf<HTMLHeadingElement>) => {
    let headings = defaultHeadings || document.querySelectorAll<HTMLHeadingElement>(".main h2[id], .main h3[id]");
  ...
  const recomputeTOC: (headings?: NodeListOf<HTMLHeadingElement>) => void = (headings) => updateTOC(headings);
