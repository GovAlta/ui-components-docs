import { GoabBlock, GoabCallout, GoabContainer, GoabLink, GoabText } from "@abgov/react-components";
  ...
  return (
    <ComponentContent tocCssQuery="h2[id], h3[id]">
      ...
      <GoabBlock gap="m" direction="row" mb="xl">
        ...
        <GoabLink>
          <a href="/get-started/designers">Designer</a>
        </GoabLink>
        <GoabLink>
          <a href="/get-started/developers">Developer</a>
        </GoabLink>
        <GoabLink>
          <a href="/get-started/qa-testing">QA Tester</a>
        </GoabLink>
      </GoabBlock>

      <GoabContainer type="non-interactive" padding="relaxed" maxWidth="740px">
        Start with the design system to align with standards, reduce duplication, and move faster.
        It gives you a solid foundation for the common parts of government services, so your team
        can focus on solving the specific challenges of your product. Build on it — don’t build from
        scratch.
      </GoabContainer>
      ...
      <GoabText size="body-m" mb="m">
        ...
        <a href={"/patterns"}>patterns.</a> You should expect that this will cover about 80% of your
        needs in a service. When usability testing shows that a new solution or an improvement to an
        existing solution is needed, design a better solution. Use a 3rd party library, code your
        own, and/or share solutions with other teams.
      </GoabText>
      <GoabText size="body-m" mb="xl">
        <ol>
          ...
          <li>
            <a href={"/get-started/support"}>Talk to the design system team</a> to see what’s
            available and what other teams have done
          </li>
          <li>Test a better solution with users</li>
          <li>
            Share learnings from design and development back to the design system so everyone can
            learn and improve
          </li>
          <li>
            ...
            <ul>
              ...
              <li>
                Stays a snowflake (unique to your service) for now and is tracked in the{" "}
                <a href={"https://github.com/orgs/GovAlta/projects/38/views/3"}>
      ...
      <GoabCallout type="information" heading={"Remember"} size={"medium"} maxWidth={"596px"}>
        Avoid custom solutions without a genuine user need to prevent unnecessary work and save
        time.
        <br />{" "}
        <a
          href={
            "https://www.figma.com/board/bFFeTY8CI2qOqCq7yvVXK6/Design-System---Governance-Process-Map?node-id=510-1364&t=gt7XnMUq1UsmJ7Lf-4"
          }
        >
