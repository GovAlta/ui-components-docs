  ...
  return (
    <ComponentContent tocCssQuery="h2[id], h3[id]">
      ...
      <GoabText size="body-m" mt="l" mb="l">
        The design system is a shared resource for product teams to use and contribute to. We
        encourage everyone, regardless of their role, to help improve the design system.
      </GoabText>

      <GoabText size="heading-s" mt={"xl"} mb="m">
        Start by using what's in the design system
      </GoabText>
      <GoabDetails
      ...
      >
        There are open{" "}
        <a
          href="https://www.figma.com/files/1352057334427203708/team/1365458889622139826"
          target="_blank"
        >
          contribution files
        </a>{" "}
        in Figma for every component and pattern in the design system, including unpublished ideas
        and experiments.
      </GoabCallout>
      ...
      <div className="max-width-72ch contribute-page-content">
        <GoabText size="body-m" mt="l" mb="l">
          ...
          or{" "}
          <a href="https://design.alberta.ca/patterns" target="_blank">
            pattern
          </a>{" "}
          doesn’t exist in production or doesn’t meet the needs of your users, please contact the
          design system team. We’ll discuss the issue to understand it better and decide on the next
          steps together.
        </GoabText>
        ...
        <h3 id="contribution-criteria" style={{ visibility: "hidden", height: "0px" }}>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                services. Evidence could be screenshots or links to versions of it being used in
                different services.
              </td>
            </tr>
            <tr>
              ...
              <td>
                It does not replicate something already in the Design System. If it’s intended to
                replace an existing component or pattern, there is evidence to show that it’s better
                than the existing version.
              </td>
            </tr>
          </tbody>
        </GoabTable>
        <GoabText size="heading-s" mt="2xl" mb="s">
        ...
        <GoabTable width="100%" mb="xl">
          ...
          <tbody>
            <tr>
              ...
              <td>
                It creates a better and more accessible, usable, and simple experience for the user.
                The user has a greater understanding and useful control of what they are doing. It
                should be informed by research to show that it improves user experience and is
            ...
            <tr>
              ...
              <td>
                It is inclusive and accessible. It should meet or exceed accessible standards.{" "}
        ...
        <GoabText size="heading-m" mt="2xl" mb="m">
          3. Once approved, it will be added to the{" "}
          <a
            href="https://github.com/orgs/GovAlta/projects/35/views/1?filterQuery="
            target="_blank"
          >
            Design System's backlog
          </a>{" "}
        </GoabText>
        <ul>
          <li>
            When work starts, we will collaborate with you and your team to ensure the component
        ...
        <ul>
          <li>
            To help build or contribute code to the component or pattern in the design system,
            follow the <a href="#development">code contribution process</a> below.
          </li>
        </ul>
      </div>
      ...
      <div className="max-width-72ch contribute-page-content">
        ...
        <GoabText size="body-m" mt="l" mb="l">
          In order to support all of the development frameworks that service teams use, we build and
          support a library of web components. Contributing entire components can be challenging and
          time-consuming, so we recommend and encourage smaller-scale contributions instead.
        </GoabText>
        <GoabText size="heading-s" mt="xl" mb="s">
        ...
        <ol>
          <li>
            Start by reaching out on the{" "}
            <a href="https://goa-dio.slack.com/archives/C02PLLT9HQ9" target="_blank">
              #design-system-support
            </a>{" "}
            channel on slack to let us know you’re interested in contributing.
          </li>
          <li>
            ...
            <GoabCallout type="information" mt="xl">
              Since our repository is “public”, you'll need to use a different GitHub account than
              the Enterprise Managed User (EMU) account you use for your product team work.
            </GoabCallout>
          </li>
        </ol>
        <GoabText size="heading-s" mt="xl" mb="s">
        ...
        <ol start={3}>
          <li>
            Go to{" "}
            <a href="https://github.com/GovAlta/ui-components" target="_blank">
              ui-components
            </a>{" "}
            repo and clone the repo
          </li>
          ...
          <li>
            The commands above will install all necessary packages and create a “playground” folder
            containing both React and Angular environments. Since nothing in this folder is
            committed to the repository, you can freely make any changes you want. These
            environments are designed for testing purposes.
          </li>
          <li>
        ...
        <GoabText size="body-m" mt="l" mb="2xl">
          ...
          <CodeSnippet
            lang="css"
            allowCopy={true}
            code={`/libs/angular-components/src/lib/components`}
          />
        ...
        <ul>
          <li>
            If you&#39;re updating/modifying React and/or Angular wrappers, you will need to write
            unit tests in React and/or Angular
          </li>
          <li>
            It would also be recommended to add proper browser testing using jest for React wrappers
            and Svelte components.
          </li>
          <li>Manually test in React and Angular</li>
        </ul>
        <GoabText size="body-m" mt="l" mb="l">
          Additionally, one of our developers will manually test the PR to ensure the
          components&#39; quality and functionality.
        </GoabText>
        <GoabSpacer vSpacing="s"></GoabSpacer>
