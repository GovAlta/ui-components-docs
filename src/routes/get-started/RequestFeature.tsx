  ...
  return (
    <ComponentContent>
      ...
      <GoabText size="body-m" mt="l" mb="l">
        First, check the{" "}
        <a href="https://github.com/orgs/GovAlta/projects/35/views/1?filterQuery=" target="_blank">
          design system backlog
        </a>{" "}
        to see if someone else has already identified a similar need or idea.
      </GoabText>
      <GoabText size="heading-m" mt="2xl" mb="m">
        2. Talk to us
      </GoabText>
      <GoabText size="body-m" mt="l" mb="l">
        If a component or pattern doesn't exist in production or doesn't meet the needs of your
        users, contact the design system team. We'll discuss the issue to understand it better and
