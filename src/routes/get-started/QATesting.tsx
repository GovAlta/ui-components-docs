    ...
    <>
      ...
      <div className="body-callout">
        ...
        >
          ...
          <strong>
            If problems found regarding components <a href="#">report a bug</a>
          </strong>
        </GoACallout>
      </div>
      ...
      <ul>
        ...
        <li>
          The developed component is validated on all popular browsers leading
      ...
      <ul>
        <li>
          ...
          the built-in screen reader for Mac and iOS devices, offers a range of
          features to enhance accessibility such as Spoken Feedback, Navigation
          and Gestures, Web Page Navigation, Multi-language Support.
        </li>
        <li>
          <strong>Apple VoiceOver (Mac):</strong> Apple VoiceOver, the built-in
          screen reader for Mac and iOS devices, offers a range of features to
          enhance accessibility such as Spoken Feedback, Navigation and
          Gestures, Web Page Navigation, Multi-language Support.
        </li>
      </ul>
      <p>
      The design system team uses <a href="https://www.lambdatest.com/">LambdaTest</a> which offers built-in accessibility testing features using NVDA for Windows and VoiceOver for macOS, allowing to easily test the accessibility of our components
      </p>
      <p>
      To see the latest updates, additions, changes, and improvements to our design system, view our <a href="https://github.com/GovAlta/ui-components/releases">release notes on GitHub</a>.
      </p>
    </>
  );
};
