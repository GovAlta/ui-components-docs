  ...
  return (
    <ComponentContent tocCssQuery="h2[id], h3[id]">
      ...
      <GoabText size="body-l" mb="2xl">
        Outline of the testing procedure for the DDD design system. The procedure ensures that all
        components function correctly and integrate seamlessly within DDD products.
      </GoabText>
