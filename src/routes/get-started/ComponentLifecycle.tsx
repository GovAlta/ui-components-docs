  ...
  return (
    <ComponentContent tocCssQuery="h2[id], h3[id]">
      ...
      <GoabText size="body-m" mb="2xl">
        ...
        <GoabText size="body-m" mb="xs"><strong>Characteristics:</strong></GoabText>
        ...
        <GoabText size="body-m" mb="xs"><strong>Goals</strong></GoabText>
        ...
        <GoabText size="body-l" mb="m">
          Older components supported primarily for existing implementations; transition to alternative is recommended.
        </GoabText>
        <GoabText size="body-m" mb="xs"><strong>Characteristics:</strong></GoabText>
        <ul style={{ marginBottom: "1.5rem" }}>
