  ...
  return (
    <ComponentContent tocCssQuery="h2[id], h3[id]">
      ...
      <div className="max-width-72ch">
        ...
        <ol>
          ...
          <li>
            <strong>Operable</strong> – User interface components and navigation must be operable.
                    ...
                    <li>
            <strong>Undersandable</strong> – Information and the operation of the user interface must be understandable.
          </li>
                    <li>
            <strong>Robust</strong> – Content must be robust enough that it can be interpreted reliably by operating systems, web browsers, and assistive technologies.
          </li>
        ...
        <ul>
          <li>
            <strong>Colour contrast</strong> - Our components all meet <a href="https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum.html">colour contrast</a> ratios following WCAG 2.2 guidance. In Figma, you can use <a href="https://www.figma.com/community/plugin/734693888346260052/able-friction-free-accessibility">the Able plugin</a> to check colour contrast in your designs.
          </li>
          <li>
            <strong>Text-size</strong> - We recommend using text no smaller than 16px for adequate readability by all users. 
          </li>
          <li>
            <strong>Avoid using colour as the sole indicator of information</strong> - For instance, always supply an icon or text to communicate, rather than relying on colour alone. Colour-only changes do not work well for those who may be colour blind or have low vision. 
          </li>
        ...
        <h3>Interaction</h3>
         <ul>
          <li>
            <strong>Visually distinct designs for every component state</strong> - Such as focus, hover, focus + hover, active, selected, disabled, and anything else that might be relevant.
          </li>
          <li>
            <strong>Large touch targets</strong> - <a href="https://wcag.com/developers/2-5-8-target-size-minimum-level-aa/#:~:text=8%20Target%20Size%20%E2%80%93%20Minimum%20(Level%20AA)&text=All%20interactive%20targets%20should%20take,white%20space%20around%20the%20target.">Touch targets</a> should be a minimum size of 24x24 CSS pixels of space to ensure they are large enough for people with limited mobility to accurately press what they're aiming for.
          </li>
          <li>
            <strong>Avoid disabling elements on the page</strong> - If you need to disable something, consider hiding it altogether from the user and/or provide information to the user for how they can move forward. Do not disable buttons to submit a form, allow the user to submit the form and then use validation and error handling to help the user recover and correct their errors to move forward.
          </li>
            </ul>
        <h3>Content</h3>
        <ul>
          <li>
            <strong>Clear language</strong> - Use simple, straightforward language to ensure that content is easily understandable. Avoid jargon and technical terms; if they must be used ensure they are clearly defined. Aim for an accessible reading level to accommodate a broad audience.
          </li>
          <li>
            <strong>Structured headings and labels</strong> - Organize content using hierarchical headings and labels to provide a clear structure. This helps users, especially those with cognitive disabilities or those using screen readers, to navigate and comprehend information more effectively.
          </li>
          <li>
            <strong>Feedback and error messages</strong> - Design clear, concise feedback and error messages that are easy to understand.
          </li>
        ...
        <ul>
          <li>
            <strong>Accessible Rich Internet Applications (ARIA) attributes</strong> provide ways to make applications more accessible by supplementing HTML so that common interactions in applications can be properly utilized with assistive technology.
          </li>
          <li>
            <strong>Accessible Properties in Components</strong> - Our design system components come with automatically included ARIA behaviours and properties. These are clearly documented to help developers understand and correctly implement accessibility features without the need for extensive modifications.
          </li>
          <li>
            <strong>Keyboard Navigation</strong> is essential for users who rely on keyboard-only interactions. All interactive elements are accessible through logical tab sequences with visible focus indicators present.
          </li>
          <li>
            <strong>Performance Optimization</strong> - Ensuring that websites are optimized for speed and responsiveness, which can significantly affect users with older technology or slower internet connections.
          </li>
        ...
        <ul>
          <li>
            <strong>NVDA (NonVisual Desktop Access</strong> - A free and open-source screen reader for Windows.
          </li>
          <li>
            <strong>VoiceOver</strong> - An integrated screen reader in all Apple operating systems.
          </li>
         <li>
            <strong>JAWS (Job Access With Speech)</strong> - A comprehensive screen reader for Windows. <a href="url">Request a licence.</a>
          </li>
        ...
        <ul>
          <li>
            <strong>Axe</strong> - An accessibility testing tool that works both as a browser extension and within development testing environments.
          </li>
          <li>
            <strong>Wave</strong> - A suite of evaluation tools that helps authors make their web content more accessible to individuals with disabilities.
          </li>
          <li>
            <strong>Lighthouse</strong> - An open-source, automated tool for improving the quality of web pages, with audits for performance, accessibility, progressive web apps, and more.
          </li>
      ...
      <p>Proper use of ARIA roles and HTML headings is essential for creating accessible web content. These elements help assistive technologies interpret the structure and function of a webpage, enabling users with disabilities to navigate and interact more effectively. Here’s how to implement basic roles and headings:</p>
        ...
        <h3>HTML Headings</h3>
          <ul>
          <li><stong>Structure</stong> - Use headings to structure content hierarchically. Begin with an h1 for the main title of the page, followed by h2 for main section titles, and h3 (and so forth) for subsections. This hierarchical use of headings helps users with screen readers understand the layout and navigate the content efficiently.</li>
        ...
        <h3>Use of ARIA Live Regions</h3>
          ...
          <li><strong>Examples</strong> - Common applications include updating a error summary, notification messages, or the status of ongoing processes.</li>
          </ul>
...
<p><strong></strong>Design system component</strong></p>
