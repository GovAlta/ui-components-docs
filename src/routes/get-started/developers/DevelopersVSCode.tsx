...
export const DevelopersVSCode: React.FC = () => {
  return (
    <>
      <div className="developers-vscode-page">
        <h1>Developers</h1>
        <h2>VS Code</h2>
        <p>
          You can use VS Code's autocomplete suggestions for design system
          components and design tokens.
        </p>
        <h3>Design tokens autocomplete</h3>
        <p>
          Get code autocomplete suggestions for the{" "}
          <a href="/design-tokens">goa design tokens.</a>
        </p>
        <ul>
...
export default DevelopersVSCode;
