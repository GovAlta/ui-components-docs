    ...
    <div className="developer-setup">
      <ComponentContent tocCssQuery="h2[id], h3[id]">
        ...
        <GoabText size="body-l" mb="2xl">
          Step-by-step guide to updating your code from DDD Design System v3 to v4 (Angular) and v5
          to v6 (React)
        </GoabText>
        ...
        <GoabText size="body-m" mt="l" mb="l">
          <ul>
            <li>
              <strong>Type-ahead support for Angular components:</strong> Get coding faster with
              smart suggestions directly in your IDE.
            </li>
            <li>
              <strong>New features and properties added across existing components:</strong> More
              flexibility, and improved accessibility.
            </li>
            <li>
              <strong>New components available:</strong> Build more complex interfaces with less
              custom code.
            </li>
            <li>
              <strong>Improved error checking during builds:</strong> Catch issues earlier for a
              smoother development experience.
            </li>
          </ul>
        </GoabText>
        <GoabText size="body-m" mt="l" mb="l">
          This guide will help you update your project to DDD Design System v4 (Angular) and v6
          (React).
        </GoabText>
        ...
        <GoabCallout
          size="medium"
          type="important"
          heading={"Legacy component: Form stepper"}
          mb={"l"}
          mt={"xl"}
          maxWidth={"65ch"}
        >
          The component is stable and supported in the latest major release. However, we recommend
          using the <a href="/patterns/public-form">public form pattern</a> for a more modular,
        ...
        <GoabContainer mt="xl">
          ...
          <GoabText size="body-m" mt="l">
            One of the most significant changes in v4 (Angular) and v6 (React) is the renaming of
            component prefixes to align better across frameworks. In React, the prefix changes from{" "}
            <InlineCode>GoA</InlineCode> to <InlineCode>Goab</InlineCode>, while in Angular, it
            changes from <InlineCode>goa-</InlineCode> to <InlineCode>goab-</InlineCode>. See the
            following examples:
          </GoabText>
        ...
        <GoabCallout type="information" heading="Watch a real service upgrade" maxWidth="65ch">
          See a real government service go through a version update in this short, three-part video
          series:
          <ol>
            <li>
            ...
            <li>
              <strong>Updating component props</strong> – adjust component properties and clean up
              warnings
            </li>
          </ol>
          <p>
