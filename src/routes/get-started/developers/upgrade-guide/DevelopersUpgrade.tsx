  ...
  return (
    <div className="developer-setup">
      <ComponentContent tocCssQuery="h2[id], h3[id]">
        ...
        <p>
          This guide will help you update your project to DDD Design System v4. The update
        ...
        <GoAContainer>
          <h3>Major differences between V3 and V4</h3>
          <p>
            One of the most significant changes in v4 is the renaming of component prefixes to align
