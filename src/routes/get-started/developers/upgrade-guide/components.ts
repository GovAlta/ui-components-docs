...
export const components: UpgradedComponent[] = [
    ...
    react: [
      {
        name: "direction",
        v3: "Direction",
        v4: "GoabBlockDirection",
      },
      {
        name: "alignment",
        v3: "Alignment",
        v4: "GoabBlockAlignment",
      },
    ],
    angular: [
      {
  ...
  },
  {
    ...
    react: [
      {
        name: "onChange",
        v3: "(name: string, value: boolean) => void;",
        v4: "(details: GoabCheckboxOnChangeDetail) => void;",
      },
    ],
    angular: [
      {
  ...
  },
  {
    ...
    react: [
      {
        name: "onChange",
        v3: "(name: string, value: Date) => void;",
        v4: "(details: GoabDatePickerOnChangeDetail) => void;",
      },
    ],
    angular: [
      {
  ...
  },
  {
    ...
    react: [
      {
        name: "onChange",
        v3: "(name: string, value: string) => void;",
        v4: "(details: GoabDropdownOnChangeDetail) => void;",
      },
    ],
    angular: [
      {
    ...
    react: [
      {
        name: "onDelete",
        v3: "() => void;",
        v4: "(detail: GoABFileUploadOnDeleteDetail) => void;",
      },
      {
        name: "onCancel",
        v3: "() => void;",
        v4: "(detail: GoABFileUploadOnCancelDetail) => void;",
      },
    ],
    angular: [
      {
    ...
    react: [
      {
        name: "onSelect",
        v3: "(file: File) => void;",
        v4: "(detail: GoabFileUploadInputOnSelectFileDetail) => void;",
      },
    ],
    angular: [
      {
    ...
    react: [
      {
        name: "onChange",
        v3: "(step: number) => void;",
        v4: "(detail: GoabFormStepperOnChangeDetail) => void;",
      },
    ],
    angular: [
      {
    ...
    react: [
      {
        name: "onChange",
        v3: "(name: string, value: string) => void;",
        v4: "(details: GoabInputOnChangeDetail) => void;",
      },
      {
        name: "onFocus",
        v3: "(name: string) => void;",
        v4: "(details: GoabInputOnFocusDetail) => void;",
      },
      {
        name: "onBlur",
        v3: "(name: string, value: string) => void;",
        v4: "(details: GoabInputOnBlurDetail) => void;",
      },
      {
        name: "onKeyPress",
        v3: "(name: string, value: string, key: string) => void;",
        v4: "(details: GoabInputOnKeyPressDetail) => void;",
      },
    ],
    angular: [
      {
    ...
    react: [
      {
        name: "onChange",
        v3: "(page: number) => void;",
        v4: "(details: GoabPaginationOnChangeDetail) => void;",
      },
    ],
    angular: [
      {
    ...
    react: [
      {
        name: "onChange",
        v3: "(name: string, value: string) => void;",
        v4: "(details: GoabRadioGroupOnChangeDetail) => void;",
      },
    ],
    angular: [
      {
    ...
    react: [
      {
        name: "hSpacing",
        v3: "Spacing | 'fill'",
        v4: "GoabSpacerHorizontalSpacing",
      },
      {
        name: "vSpacing",
        v3: "Spacing",
        v4: "GoabSpacerVerticalSpacing",
      },
    ],
    angular: [
      {
  ...
  },
  {
    ...
    react: [{
        name: "onSort",
        v3: "(sortBy: string, sortDir: number) => void;",
        v4: "(details: GoabTableOnSortDetail) => void;",
      }],
    angular: [
      {
        v3: {
    ...
    react: [
      {
        name: "onChange",
        v3: "(tab: number) => void;",
        v4: "(details: GoabTabsOnChangeDetail) => void;",
      },
    ],
    angular: [
      {
    ...
    react: [
        {
          name: "countBy",
          v3: "CountBy",
          v4: "GoabTextAreacountBy",
        },
        {
          name: "onChange",
          v3: "(name: string, value: string) => void;",
          v4: "(details: GoabTextAreaOnKeyPressDetail) => void;",
        },
        {
          name: "onKeyPress",
          v3: "(name: string, value: string, key: string) => void;",
    ...
    react: [
        {
          name: "onChange",
          v3: "(name: string, value: Date) => void;",
          v4: "(details: GoabCalendarOnChangeDetail) => void;",
        },
      ],
    angular: [
        {
