  ...
  return (
    <>
      ...
      <p>
        ...
        <InlineCode>@abgov/react-components</InlineCode> package. However, starting with version 4,
      ...
      <p>
        In v4, some of our properties have changed, go through the following table and make changes as necessary in your codebase.
      </p>
            ...
            <tr key={index}>
              ...
              <td>
                <ul>
                  {component.react?.map((prop, propsIndex) => (
                    <li key={propsIndex}>
                      {prop.name}: {prop.v3 && <span>{prop.v3}</span>} {prop.v3 == null && "N/A"}
                    </li>
                  ))}
                </ul>
              </td>
              <td>
                <ul>
                  {component.react?.map((prop, propsIndex) => (
                    <li key={propsIndex}>
                      {prop.name}: {prop.v4 && <span>{prop.v4}</span>}{" "}
