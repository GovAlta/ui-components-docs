  ...
  return (
    <ComponentContent tocCssQuery="h2[id], h3[id]">
      ...
      <GoabText size="body-m" mt="l" mb="l">
        Follow these steps when you encounter issues with our design system components. This process
        helps isolate problems, streamlines investigation, and speeds up resolution.
      </GoabText>
      ...
      <GoabText size="body-m" mb="2xl">
        <ul>
          <li>
            <a href="https://github.com/GovAlta/ui-components-angular-template">
              Test with Angular template
            </a>
          </li>
          <li>
            <a href="https://github.com/GovAlta/ui-components-react-template">
              Test with React template
            </a>
          </li>
        </ul>
      </GoabText>
      ...
      <ul>
        <li>
          Share the template app link in the{" "}
