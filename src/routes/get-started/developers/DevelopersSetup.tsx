...
export const DevelopersSetup: React.FC = () => {
  ...
  return (
    <div className="developers-setup-page">
      <h1>Developers</h1>
      <h2>Setup</h2>
      <GoABlock gap="2xl">
      ...
      <GoAContainer type="non-interactive">
        ...
        <GoAButton onClick={handleButtonClick} type="tertiary">
      ...
      <p>
        This library contains React components which wrap the Government of
        Alberta Web Components.
      </p>
      <h4>1. Add Dependencies</h4>
      <CodeSnippet
        lang="typescript"
      ...
      ></CodeSnippet>
      <h4>
        5. Add the styles link in the src/assets/main.css file or wherever your
        main css file is located:
      </h4>
      <CodeSnippet
        lang="typescript"
        tags="react"
      ...
      <p>
        ...
        <ol>
          ...
          <li>
            Using a terminal of some kind, go into the directory you created and
            run the following commands (in order):
            <ol className="developers-setup_block-sublist">
              <li>npm i</li>
              <li>npm run build</li>
              <li>
                npm run start-- if using Angular, npm run dev --if using react
              </li>
            </ol>
          </li>
