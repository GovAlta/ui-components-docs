...
export default function ImagesPage() {
  return (
      <ComponentContent>
        ...
        <h3>Accessing the GoA photo library</h3>
        ...
        <ol>
          ...
          <li>Enter your credentials including the username and password in the format shown below: 
            <ul>
              <li>Username: goa\firstname.lastname</li>
              <li>Password: [your-goa-password]</li>
            </ul>  
          </li>
          ...
          <li>You will see a few details of the photo listed on the Photo information page that opens.<br/>To request this photo, write an email to <a href="mailto:visual@gov.ab.ca" target="_blank">visual@gov.ab.ca</a> sharing the following details that you can find under Photo information section of the selected photo.
            <ul>
              <li>Photo name</li>
        ...
        <h3>Photos for sensitive subjects</h3>
        ...
        <h3>Photo selection guidelines</h3>
        ...
        <p>If you are working with images, please make sure to reference <a href="https://www.w3.org/WAI/tutorials/images/" target="_blank">W3G's Images tutorial</a> to know the accessibility best practices for various image formats.</p>
      </ComponentContent>
  );
}
