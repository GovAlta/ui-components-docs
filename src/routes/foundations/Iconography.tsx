...
export default function IconographyPage() {
    ...
    return (
      <GoabTable width="100%" variant="relaxed">
        ...
        <tbody>
          <tr>
            <td>
              <img src="/images/iconography/Icon-small.png"></img>
            </td>
          ...
          <tr>
            <td>
              <img src="/images/iconography/Icon-Medium.jpg"></img>
            </td>
          ...
          <tr>
            <td>
              <img src="/images/iconography/Icon-Large.jpg"></img>
            </td>
      ...
      <GoabGrid minChildWidth="22rem" gap="xs">
        <GoabContainer>
          <dl className="design-tokens">
            ...
            <dt>Icon size</dt>
            <dd>Small: icon-size-s</dd>
            <dt>Description</dt>
            <dd>Used in compact spaces</dd>
          </dl>
        </GoabContainer>
        <GoabContainer>
          <dl className="design-tokens">
            ...
            <dt>Icon size</dt>
            <dd>Medium: icon-size-m</dd>
            <dt>Description</dt>
            <dd>Suitable for slightly larger spaces</dd>
          </dl>
        </GoabContainer>
        <GoabContainer>
          <dl className="design-tokens">
            ...
            <dt>Icon size</dt>
            <dd>Large: icon-size-l</dd>
            <dt>Description</dt>
            <dd>Used in dense spaces where an icon is required</dd>
          </dl>
        </GoabContainer>
      </GoabGrid>
    );
  ...
  return (
    <ComponentContent tocCssQuery="h2[id], h3[id]">
      <h1>Iconography</h1>
      <h3>
        Icons are simple and universal graphic symbols that communicate and enhance both the
        aesthetic and functional aspects of our products. While they can be used with descriptors,
        they can also be self-expressive and convey meaning where words cannot.{" "}
      </h3>
      ...
      <div className="max-width-72ch">
        ...
        <p>
          Our icon style is simple, rounded, featuring thin line strokes, or filled shapes. They are
          designed to scale proportionally, ensuring that they integrate seamlessly into various
          interface sizes. They are divided into three categories: Core, Extended and Logo icon set.
        </p>

        <h3 id="core">Core icon set</h3>
        <p>
          Our core icon set is the main icon library in the design system, helping you maintain
          visual consistency across all our digital products.
        </p>
        ...
        <GoabGrid gap="s" minChildWidth="250px">
          <GoabContainer mb="3xs">
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ font: "var(--goa-typography-body-xs)", margin: "16px 0 0" }}>
                Alert and messaging
              </p>
            </div>
          </GoabContainer>
        ...
        <p>
          ...
          <Link to="/components/icons">on the component page</Link>.
        </p>

        <h3 id="extended">Extended icon set</h3>
        <h4>Ionicons</h4>
        <p>
          We use the open-source icon library,{" "}
          <a href="https://ionic.io/ionicons" target="_blank">
            Ionicons
          </a>
          , which provides a wide variety of high-quality icons. Use these icons when you need
          options beyond the core icon set.
        </p>
        ...
        <p>
          Our{" "}
          <a
            href="https://www.figma.com/design/ylmHeuDMfxnDBnP1VaQYz8/%E2%9D%96-Styles-and-Guidelines-%7C-DDD?node-id=36-7"
            target="_blank"
          >
            Figma component library
          </a>{" "}
          contains popular brand logos and are kept in accordance with their respective logo usage
          guidelines. When using any of these brand logos, please make sure to refer to their brand
          guideline to ensure compliance with their usage standards.
        </p>
        ...
        <p>
          You can access the{" "}
          <Link to="/design-tokens/icon-size">design tokens for icon sizes here</Link>.
        </p>

        <p>
          When icons are interactive, it's best to make them 24 x 24 CSS pixels to meet{" "}
          <a
        ...
        <ul>
          ...
          <li>
            When placing icons next to text elements, ensure they are vertically aligned to create
            visual balance.
          </li>
          <li>Do not create icons that are overly complex.</li>
          <li>
            Apply color to an icon using our <Link to="/design-tokens/color">design tokens</Link>.
            Ensure color combinations meet{" "}
            <a
            ...
            of at least a 3:1 contrast ratio between foreground and background.
          </li>
        </ul>

        <h2 id="creating-icons">Creating icons</h2>
        <p>
          Before creating an icon, check if it already exists in the icon library. If not, you can
          follow these steps:
        </p>
        <ul>
