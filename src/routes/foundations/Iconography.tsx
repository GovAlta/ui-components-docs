      ...
      <ComponentContent>
        ...
        <GoABlock mt="xl" mb="xl">
          <DoDont type="generic">
            <div style={{ textAlign: "center" }}>
              <p>img here</p>
              <p style={{ font: "var(--goa-typography-body-xs)" }}>Alert and messaging</p>
            </div>
          </DoDont>
        </GoABlock>
        ...
        <GoABlock mt="xl" mb="xl">
          <DoDont type="generic">
            <div style={{ textAlign: "center" }}>
              <p>img here</p>
              <p style={{ font: "var(--goa-typography-body-xs)" }}>Basic</p>
            </div>
          </DoDont>
        </GoABlock>
        ...
        <GoABlock mt="xl" mb="xl">
          <DoDont type="generic">
            <div style={{ textAlign: "center" }}>
              <p>img here</p>
              <p style={{ font: "var(--goa-typography-body-xs)" }}>Direction</p>
            </div>
          </DoDont>
        </GoABlock>
        ...
        <GoABlock mt="xl" mb="xl">
          <DoDont type="generic">
            <div style={{ textAlign: "center" }}>
              <p>img here</p>
              <p style={{ font: "var(--goa-typography-body-xs)" }}>Interactions</p>
            </div>
          </DoDont>
        </GoABlock>
        ...
        <GoABlock mt="xl" mb="xl">
          <DoDont type="generic">
            <div style={{ textAlign: "center" }}>
              <p>img here</p>
              <p style={{ font: "var(--goa-typography-body-xs)" }}>Accounts</p>
            </div>
          </DoDont>
        </GoABlock>
