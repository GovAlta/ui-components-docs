import { GoADivider, GoAContainer, GoATable, GoASpacer, GoAGrid } from "@abgov/react-components";
      ...
      <GoAGrid minChildWidth="22rem" gap="xl">
        <GoAContainer>
          <dl className="design-tokens">
            ...
            <dt>Type family</dt><dd>Acumin Pro SemiCondensed</dd>
            <dt>Weight</dt><dd>Bold</dd>
            <dt>Font size</dt><dd>48px | 3rem</dd>
            <dt>Line height</dt><dd>56px | 3.5rem</dd>
          </dl>
        </GoAContainer>
        <GoAContainer>
          <dl className="design-tokens">
            <dd style={{ margin:"0 0 24px", }}><div style={{ font: "var(--goa-typography-heading-l)", }}>Large heading</div></dd>
            <dt>Type family</dt><dd>Acumin Pro SemiCondensed</dd>
            <dt>Weight</dt> <dd>Regular</dd>
            <dt>Font size</dt><dd>36px | 2.25rem</dd>
            <dt>Line height</dt><dd>44px | 2.75rem</dd>
          </dl>
        </GoAContainer>
        <GoAContainer>
          <dl className="design-tokens">
            <dd style={{ margin:"0 0 24px", }}><div style={{ font: "var(--goa-typography-heading-m)", }}>Medium heading</div></dd>
            <dt>Type family</dt><dd>Acumin Pro SemiCondensed</dd>
            <dt>Weight</dt> <dd>Regular</dd>
            <dt>Font size</dt><dd>24px | 1.5rem</dd>
            <dt>Line height</dt><dd>32px | 2rem</dd>
          </dl>
        </GoAContainer>
        <GoAContainer>
          <dl className="design-tokens">
            <dd style={{ margin:"0 0 24px", }}><div style={{ font: "var(--goa-typography-heading-s)", }}>Small heading</div></dd>
            <dt>Type family</dt><dd>Acumin Pro SemiCondensed</dd>
            <dt>Weight</dt> <dd>Bold</dd>
            <dt>Font size</dt><dd>18px | 1.125rem</dd>
            <dt>Line height</dt><dd>28px | 1.75rem</dd>
          </dl>
        </GoAContainer>
        <GoAContainer>
          <dl className="design-tokens">
            <dd style={{ margin:"0 0 24px", }}><div style={{ font: "var(--goa-typography-heading-xs)", }}>XSmall heading</div></dd>
            <dt>Type family</dt><dd>Acumin Pro SemiCondensed</dd>
            <dt>Weight</dt> <dd>Bold</dd>
            <dt>Font size</dt><dd>16px | 1rem</dd>
            <dt>Line height</dt><dd>24px | 1.5rem</dd>
          </dl>
        </GoAContainer>
        <GoAContainer>
          <dl className="design-tokens">
            <dd style={{ margin:"0 0 24px", }}><div style={{ font: "var(--goa-typography-body-l)", }}>Large text</div></dd>
            <dt>Type family</dt><dd>Acumin Pro SemiCondensed</dd>
            <dt>Weight</dt> <dd>Regular</dd>
            <dt>Font size</dt><dd>24px | 1.5rem</dd>
            <dt>Line height</dt><dd>32px | 2rem</dd>
        ...
        <GoAContainer>
          <dl className="design-tokens">
            <dd style={{ margin:"0 0 24px", }}><div style={{ font: "var(--goa-typography-body-m)", }}>Medium text</div></dd>
            <dt>Type family</dt><dd>Acumin Pro SemiCondensed</dd>
            <dt>Weight</dt> <dd>Regular</dd>
            <dt>Font size</dt><dd>18px | 1.125rem</dd>
            <dt>Line height</dt><dd>28px | 1.75rem</dd>
        ...
        <GoAContainer>
          <dl className="design-tokens">
            <dd style={{ margin:"0 0 24px", }}><div style={{ font: "var(--goa-typography-body-s)", }}>Small text</div></dd>
            <dt>Type family</dt><dd>Acumin Pro SemiCondensed</dd>
            <dt>Weight</dt> <dd>Regular</dd>
            <dt>Font size</dt><dd>16px | 1rem</dd>
            <dt>Line height</dt><dd>24px | 1.5rem</dd>
        ...
        <GoAContainer>
          <dl className="design-tokens">
            <dd style={{ margin:"0 0 24px", }}><div style={{ font: "var(--goa-typography-body-xs)", }}>XSmall text</div></dd>
            <dt>Type family</dt><dd>Acumin Pro SemiCondensed</dd>
            <dt>Weight</dt> <dd>Regular</dd>
            <dt>Font size</dt><dd>14px | 0.875rem</dd>
            <dt>Line height</dt><dd>20px | 1.25rem</dd>
          </dl>
        </GoAContainer>
        <GoAContainer>
          <dl className="design-tokens">
            <dd style={{ margin:"0 0 24px", }}><div style={{ font: "var(--goa-typography-number-m)", }}>Medium number</div></dd>
            <dt>Type family</dt><dd>Roboto Mono</dd>
            <dt>Weight</dt> <dd>Regular</dd>
            <dt>Font size</dt><dd>18px | 1.125rem</dd>
            <dt>Line height</dt><dd>28px | 1.75rem</dd>
          </dl>
  ...
  const secondRenderMobile = () => {
    return (
      <GoAGrid minChildWidth="22rem" gap="m">
          ...
          <GoAContainer>
            <dl className="design-tokens">
              <dd style={{ margin:"0 0 24px", }}><div style={{ font: "var(--goa-typography-heading-l)", fontWeight: "var(--goa-font-weight-bold)" }}>Heading 3</div></dd>
              <dt>Font size</dt><dd>24px | 1.5rem</dd>
              <dt>Line height</dt><dd>32px | 2rem</dd>
              <dt>Weight</dt> <dd>Regular</dd>
            </dl>
  ...
  return (
      <ComponentContent tocCssQuery="h2[id], h3[id]">
        ...
        <div className="max-width-72ch">
          ...
          <h3 id="acumin-pro">Acumin Pro SemiCondensed</h3>
          ...
          <h3 id="paragraph-spacing">Paragraph spacing</h3>
