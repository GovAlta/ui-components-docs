  ...
  return (
    <>
      <div>
        <GoabHeroBanner
          heading={
            "Design government services using reusable examples, components, and design tokens"
          }
          maxContentWidth={MAX_CONTENT_WIDTH}
        >
          <GoabText tag="h2" size="heading-m" mt="m" mb="xl" maxWidth={"688px"}>
            Use the design system to build your service. Build on the research and experience of
      ...
      <GoabPageBlock width={MAX_CONTENT_WIDTH}>
        ...
        <GoabGrid gap="xl" minChildWidth="320px">
          <div>
            <GoabText size={"heading-l"} mb={"l"}>
              <b> Start by using the design system in your service</b>
            </GoabText>
            <GoabText size={"body-m"} mb={"m"}>
              Use the existing components and patterns in the design system to save time and build
              off of the current standard. Typically, these cover around 80% of your service's
              needs.
            </GoabText>
            <GoabText size={"body-m"} mb={"l"}>
              <a href={"/get-started/support"}>Talk to the Design System team</a> before creating a
              custom solution. This way you can see what’s available, what other teams have already
              done, and avoid repeating work.
            </GoabText>
          ...
          <div>
            ...
            >
              <GoabText size={"body-m"} mb={"m"}>
                If a component or pattern doesn’t exists in the design system or doesn’t meet the
                needs of your users, follow the process below:
              </GoabText>
              ...
              >
                <img
                  src="/images/governance-process.png"
            ...
            <GoabCallout type="information" size="medium" maxWidth="480px">
              Avoid custom solutions without a genuine user need to prevent unnecessary work and
              save time.
            </GoabCallout>
          </div>
        </GoabGrid>

        <GoabText size={"heading-l"} mt={"3xl"} mb={"xl"}>
        ...
        <GoabGrid gap="xl" minChildWidth="320px">
          <GoabContainer type="non-interactive" accent="filled" padding="relaxed" width="full">
            ...
            <GoabText size={"body-m"} mb={"m"}>
              A directory of reusable backend services designed to help you and your team work more
              efficiently and align to government infrastructure standards.
            </GoabText>
            <GoabLink>
              <a
          ...
          <GoabContainer type="non-interactive" accent="filled" padding="relaxed" width="full">
            ...
            <GoabText size={"body-m"} mb={"m"}>
              These resources establish best practices to shape and guide the work of DDD user
