...
export default function CheckboxPage() {
    ...
    return (
      cards
        ...
        .map((card: ComponentProps) =>
          <ComponentCard key={card.name} name={card.name} groups={card.groups} description={card.description} />
        )
    )
  }
  ...
  return (
    <>
      ...
      <h1>Components</h1>
      <h3>
        Components are reusable parts of the user interface that have been made to support a
        variety of applications. You can use individual components in many different
