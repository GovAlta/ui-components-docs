...
export default function CheckboxPage() {
  const cards: ComponentProps[] = [
    ...
    },
    {
      ...
      groups: ["feedback"],
      description:
        "A temporary notification showing a process started or completed.",
    },
    {
      name: "tooltip",
      groups: ["feedback"],
      description:
        "More information displayed in a popover when a user hovers over an element.",
    },
    ...
    },
    {
      ...
      groups: ["inputs"],
      description:
        "Functions like a dropdown with the ability to filter options by typing.",
    },
    {
      name: "dropdown",
      groups: ["inputs"],
    ...
    },
    {
      ...
      groups: ["inputs"],
      description:
        "Let users enter and input text for multiple lines of information.",
    },
    {
      name: "input",
      groups: ["inputs"],
      tags: ["text"],
      description:
        "Let users enter and input text for a single line of information.",
    },
    ...
    },
    {
      ...
      groups: ["structure"],
      description:
        "Communicate what stage the service is at, and connect to Alberta.ca.",
    },
    {
      name: "pagination",
      groups: ["structure"],
  ...
  function getComponentsByFilter(): ReactNode[] {
    return cards
      .filter(
        (card) => card.name.includes(filter) || card.tags?.includes(filter)
      )
      .map((card: ComponentProps) => (
        <ComponentCard
          key={card.name}
  ...
  return (
    <>
      ...
      <h3>
        ...
        to support a variety of applications. You can use individual components
        in many different patterns and contexts.
      </h3>
      ...
      {mode === "search" && (
        <GoAGrid minChildWidth="300px">{getComponentsByFilter()}</GoAGrid>
      )}
