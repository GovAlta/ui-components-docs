        ...
        <GoabTabs initialTab={1}>
          ...
          <GoabTab heading="All">
            <GoabBlock gap="xl" mb="xl" direction="column">
              ...
              <h2 id="skeleton-card" style={{ display: "none" }}>
                Card
              </h2>
              ...
              <h2 id="skeleton-image" style={{ display: "none" }}>
                Image
              </h2>
              ...
              <h2 id="skeleton-text" style={{ display: "none" }}>
                Text
              </h2>
              ...
              <h2 id="skeleton-small-text" style={{ display: "none" }}>
                Small text
              </h2>
              ...
              <h2 id="skeleton-title" style={{ display: "none" }}>
                Title
              </h2>
              ...
              <h2 id="skeleton-header" style={{ display: "none" }}>
                Header
              </h2>
              ...
              <h2 id="skeleton-paragraph" style={{ display: "none" }}>
                Paragraph
              </h2>
              ...
              <h2 id="skeleton-thumbnail" style={{ display: "none" }}>
                Thumbnail
              </h2>
              ...
              <h2 id="skeleton-avatar" style={{ display: "none" }}>
                Avatar
              </h2>
              ...
              <h2 id="skeleton-profile" style={{ display: "none" }}>
                Profile
              </h2>
