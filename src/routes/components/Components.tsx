...
export function Components() {
  ...
  const customComponentLabel = (componentName: string, customLabel: string, badgeType: GoabBadgeType) => {
    return (
      <GoabBlock alignment="center">
        ...
        <section className="side-menu">
          <GoabSideMenu>
            ...
            <GoabSideMenuGroup heading="Structure and navigation">
              ...
              <Link to={getUrl("form-stepper")}>{customComponentLabel("Form stepper", "Legacy", "information")}</Link>
