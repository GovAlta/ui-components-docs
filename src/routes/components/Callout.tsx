...
import {
  ...
  GoabTabs,
  GoabCallout,
  GoabCalloutProps, GoabSpacer, GoabButtonGroup, GoabButton
            ...
            <Sandbox fullWidth allow={['h2', 'h3', 'p']} skipRender>
              ...
              {version === "new" && <CodeSnippet
                ...
                code={`
                    ...
                    <goab-callout type="success" [heading]="heading">
                      <ng-template #heading>Your application was successful</ng-template>
                        <p>You will receive a copy of the confirmation to the email person&#64;email.com</p>
                        <p>Confirmation number: <strong>1234ABC</strong></p>
                    </goab-callout>
