...
const description = "Provide structure to help users find their way around the service.";
...
export default function AppHeaderPage() {
  ...
  const oldComponentProperties: ComponentProperty[] = [
    ...
    ...LegacyTestIdProperties,
    {
      ...
      lang: "angular",
      description:
        "Set to true to handle the menu click event via _menuClick event custom event handler. Defaults to false.",
    },
    {
      name: "_menuClick",
      type: "CustomEvent",
      lang: "angular",
      description:
        "Function invoked when the menu hamburger button (on mobile/tablet device) is clicked.",
    },
    {
      name: "onMenuClick",
      type: "() => void",
