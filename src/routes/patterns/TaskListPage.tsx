      ...
      <ComponentContent
        ...
        <GoATabs>
          ...
          <GoATab heading="Design guidelines">
            ...
            <ol>
              <li>
                Page tile: <Link to="#">heading-large</Link>
              </li>
              <li>
                Status of completed sections: <Link to="#">goa-callout</Link>
              </li>
              <li>
                Section: <Link to="#">task-list-section</Link>
              </li>
              <li>
                Section heading: <a href="#">heading-medium</a>
              </li>
              <li>
                Task: <a href="#">goa-table</a>
              </li>
            </ol>
          </GoATab>
        </GoATabs>
