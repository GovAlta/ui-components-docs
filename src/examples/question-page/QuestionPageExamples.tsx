    ...
    <div className="question-page-example">
      ...
      <Sandbox fullWidth allow={["h2", "h3"]}>
        ...
        <CodeSnippet
          ...
          code={`
            ...
            .form-header h2.section-title + h3 {
      ...
      <Sandbox fullWidth allow={["h2", "h3"]}>
        ...
        <CodeSnippet
          ...
          `}
        />
        <GoAButton type="tertiary" leadingIcon="arrow-back" mb="xl">
          Back
        </GoAButton>
        <h3 className="section-title">Step 1 of 5</h3>
        ...
        <GoAFormItem label="What is your home postal code?" mt="xl">
          <GoAInput
            ...
            name="postal-code"
            width="14ch"
            ariaLabel="what is your home postal code, max length is 6"
            maxLength={6}></GoAInput>
        </GoAFormItem>
        <GoAButton type="submit" mt="2xl">
          Save and continue
        </GoAButton>
