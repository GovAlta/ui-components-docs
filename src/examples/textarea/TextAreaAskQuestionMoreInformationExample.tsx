  ...
  return (
    <Sandbox flags={["reactive"]} fullWidth allow={["form", "h2", "p"]}>
      ...
      <GoabContainer>
        ...
        <p>
          If you need clarification about your benefit eligibility, payment schedule, or application
          status, submit your question here.
        </p>
        <form>
          <GoabFormItem
        ...
        <GoabDetails mt={"m"} heading="What kind of information is useful?">
          <p>
            Include your benefit program name, mention any recent correspondence you received and/or
