  ...
  return (
    ...
    <>
      <GoabContainer width="full" mt="m" mb="none">
        ...
        {typedChips.length > 0 && (
          <div>
            <GoabText as="span" mr="xs" color="secondary">
              Filter:
            </GoabText>
            {typedChips.length > 0 &&
...
<ng-container *ngIf="typedChips.length > 0">
  <goa-text as="span" mr="xs" color="secondary">
    Filter:
  </goa-text>
  <goa-filter-chip
...
<goa-block mt="m" *ngIf="dataFiltered.length === 0 && data.length > 0">
  ...
  useEffect(() => {
    ...
    <>
      ...
      {typedChips.length > 0 && (
        <div>
          <GoAText as="span" mr="xs" color="secondary">
            Filter:
          </GoAText>
          {typedChips.length > 0 &&
            typedChips.map((typedChip, index) => (
...
<ng-container *ngIf="typedChips.length > 0">
  <goab-text as="span" mr="xs" color="secondary">
    Filter:
  </goab-text>
  <goab-filter-chip
    *ngFor="let typedChip of typedChips; let index = index"
