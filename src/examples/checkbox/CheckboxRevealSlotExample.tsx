          ...
          <CodeSnippet
            ...
            code={`
              <goab-form-item [formGroup]="form" label="How would you like to be contacted?">
                <goab-checkbox formControlName="emailContactMethod" text="Email" [reveal]="phoneNumberReveal">
                ...
                <goab-checkbox formControlName="phoneContactMethod" text="Phone" [reveal]="emailReveal">
