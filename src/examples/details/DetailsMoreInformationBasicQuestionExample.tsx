...
export const DetailsMoreInformationBasicQuestionExample = () => {
  ...
  return (
    <Sandbox fullWidth note="Example below: Advanced Education - Pay for my education">
      ...
      <GoabFormItem
        label="Do you pay for childcare?"
        helpText="Examples of child care include day care, day homes, and baby-sitters."
      >
      ...
      <GoabDetails heading="Why are we asking this question?" mt="l">
        <p>
          This question helps us better understand your situation and ensure that you receive the
